...
directory = "Z:/KHE/tongue-dad/TongueDad.py/Facial-Expression-Detection-master/images/right"

## directory where the images to be saved:
f_directory = "Z:/KHE/tongue-dad/TongueDad.py/Facial-Expression-Detection-master/crop/right"
